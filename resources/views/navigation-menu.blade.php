        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\SupportLink::class)
                        <x-dropdown-link href="{{ route('support-links.index') }}">
                        Support Links
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\Certificate::class)
                        <x-dropdown-link href="{{ route('certificates.index') }}">
                        Certificates
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\LearningArtifact::class)
                        <x-dropdown-link href="{{ route('learning-artifacts.index') }}">
                        Learning Artifacts
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\LearningPath::class)
                        <x-dropdown-link href="{{ route('learning-paths.index') }}">
                        Learning Paths
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Job::class)
                <x-jet-responsive-nav-link href="{{ route('jobs.index') }}">
                Jobs
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Role::class)
                ...
                @endcan
                @can('view-any', App\Models\SupportLink::class)
                <x-jet-responsive-nav-link href="{{ route('support-links.index') }}">
                Support Links
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Team::class)
                ...
                @endcan
                @can('view-any', App\Models\Certificate::class)
                <x-jet-responsive-nav-link href="{{ route('certificates.index') }}">
                Certificates
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\LearningArtifact::class)
                <x-jet-responsive-nav-link href="{{ route('learning-artifacts.index') }}">
                Learning Artifacts
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Menu::class)
                ...
                @endcan
                @can('view-any', App\Models\LearningPath::class)
                <x-jet-responsive-nav-link href="{{ route('learning-paths.index') }}">
                Learning Paths
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Quiz::class)
