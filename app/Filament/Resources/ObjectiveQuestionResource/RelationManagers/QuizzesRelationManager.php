...
class QuizzesRelationManager extends BelongsToManyRelationManager
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns::make('time_limit'),
                Tables\Columns\TextColumn::make('cover_path')->limit(50),
                Tables\Columns\TextColumn::make('experience_amount'),
            ])
            ->filters([
